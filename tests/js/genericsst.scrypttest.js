...
describe('GenericStruct  test', () => {
    ...
    describe('test genericsst_simple', () => {
        ...
        const C = buildContractClass(compileContract('genericsst_simple.scrypt'));
    ...
    describe('test genericsst_ctor', () => {
        ...
        const C = buildContractClass(compileContract('genericsst_ctor.scrypt'));
    ...
    describe('test genericsst_alias', () => {
        ...
        const C = buildContractClass(compileContract('genericsst_alias.scrypt'));
    ...
    describe('test genericsst.scrypt', () => {
        ...
        const C = buildContractClass(compileContract('genericsst.scrypt'));
        const { ST0, ST1, ST2, ST3 } = buildTypeClasses(C);
        before(() => {
            c = new C(new ST1({
                x: 1
